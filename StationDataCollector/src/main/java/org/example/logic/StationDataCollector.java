...
public class StationDataCollector {
    ...
    public StationDataCollector(Channel channel, ChargeRepository chargeRepository) {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connection = config.createConnection();
            ...
            StationDataCollector collector = new StationDataCollector(channel, chargeRepository);
